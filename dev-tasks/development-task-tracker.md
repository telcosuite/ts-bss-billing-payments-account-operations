...
- App writes stay inside `billing_payments`; cross-app collaboration must use APIs, events, workflow tasks, governed projections, or data products.
- TMF review status: Complete (see `docs/planning/tmf-api-to-ddl-review.md` for the full V001/V00X baseline rationale); DDL baseline status: Complete; starter tables: see `database/postgres/source-migrations/V005__refine_billing_payments_tmf_core.sql`.

## Discovered Phase Summary

| Phase | Phase file | Rationale | Exit gate | Status | Notes |
| --- | --- | --- | --- | --- | --- |
| P01 - From Scratch App Foundation And Delivery Runtime | [P01-from-scratch-app-foundation-and-delivery-runtime.md](P01-from-scratch-app-foundation-and-delivery-runtime.md) | Bootstrap GitHub app repository `ts-bss-billing-payments-account-operations` and app-root runtime before feature implementation because planning has no runnable app implementation. | Clean checkout of `ts-bss-billing-payments-account-operations` can run the frontend/backend, migrate the app schema, validate Docker Compose and Kubernetes/Helm, run CI smoke checks, and prove the first UI/API/database/audit-event vertical slice. | Not Started | Updated to align with app-repo strategy. |
| P02 - Phase 2 Foundation | [P02-phase-2-foundation.md](P02-phase-2-foundation.md) | Build the first feature-area foundation specific to Billing, Payments, And Account Operations before the next set of capability slices can be built. | First feature-area foundation in `billing_payments` is testable against the V001/V00X migrations and TMF-aligned APIs. | Not Started | Generated from source feature pack. |
| P03 - Phase 3 Expansion | [P03-phase-3-expansion.md](P03-phase-3-expansion.md) | Expand the first feature area and connect to the second feature area specific to Billing, Payments, And Account Operations. | Second feature area is testable and emits or consumes the first feature area's events. | Not Started | Generated from source feature pack. |
| P04 - Phase 4 Cross Area | [P04-phase-4-cross-area.md](P04-phase-4-cross-area.md) | Wire cross-area handoffs, lifecycle transitions, and downstream events for Billing, Payments, And Account Operations. | Cross-area handoffs and event publication are tested end to end. | Not Started | Generated from source feature pack. |
| P05 - Phase 5 Release Readiness | [P05-phase-5-release-readiness.md](P05-phase-5-release-readiness.md) | Complete release-gate evidence, observability, runbooks, and support handoff for Billing, Payments, And Account Operations. | App release evidence covers privacy, audit, observability, accessibility, support, and post-launch monitoring. | Not Started | Generated from source feature pack. |

## From-Scratch Build Artifact Checklist

| Artifact area | Default target | Completion evidence |
| --- | --- | --- |
| GitHub app repository | `ts-bss-billing-payments-account-operations` | Repository exists with `README.md`, `OWNERS.md`, `CODEOWNERS`, branch protection, required checks, security scanning, and copied `dev-tasks/` from planning. |
...
| PostgreSQL | `database/postgres/migrations/` and `database/postgres/seeds/` | Clean app-repo migration run, app-owned tables for schema `billing_payments`, idempotency/audit/outbox, seed/demo data, and rollback/repair notes. |
...
| --- | --- | --- | --- | --- |
| [bill-cycle-control-and-invoice-presentment](../planning/app-detail/features/bill-cycle-control-and-invoice-presentment.md) | `features/bill-cycle-control-and-invoice-presentment.md` | derived | P02-P05 | Not Started |
| [billing-account](../planning/app-detail/features/billing-account.md) | `features/billing-account.md` | derived | P02-P05 | Not Started |
| [collections-and-adjustment](../planning/app-detail/features/collections-and-adjustment.md) | `features/collections-and-adjustment.md` | derived | P02-P05 | Not Started |
| [customer-bill](../planning/app-detail/features/customer-bill.md) | `features/customer-bill.md` | derived | P02-P05 | Not Started |
| [finance-subledger-gl-and-revenue-recognition](../planning/app-detail/features/finance-subledger-gl-and-revenue-recognition.md) | `features/finance-subledger-gl-and-revenue-recognition.md` | derived | P02-P05 | Not Started |
| [payment-and-payment-method](../planning/app-detail/features/payment-and-payment-method.md) | `features/payment-and-payment-method.md` | derived | P02-P05 | Not Started |
| [prepay-balance](../planning/app-detail/features/prepay-balance.md) | `features/prepay-balance.md` | derived | P02-P05 | Not Started |
| [refund-chargeback-deposit-and-hardship-controls](../planning/app-detail/features/refund-chargeback-deposit-and-hardship-controls.md) | `features/refund-chargeback-deposit-and-hardship-controls.md` | derived | P02-P05 | Not Started |
