# Billing, Payments, And Account Operations P04 - Phase 4 Cross Area Development Tasks
...
Phase rationale: Wire cross-area handoffs, lifecycle transitions, and downstream events for Billing, Payments, And Account Operations.
...
- [collections-and-adjustment](../planning/app-detail/features/collections-and-adjustment.md)
- [prepay-balance](../planning/app-detail/features/prepay-balance.md)

## Phase Tasks

### DT-01-billing-payments-account-operations-P04-T001: Implement P04 - Phase 4 Cross Area enablement and cross-feature controls
...
| Dependencies | DT-01-billing-payments-account-operations-P03-T012 (or earlier phase exit gate) |
...
- Feature specs in this phase: collections-and-adjustment, prepay-balance.
...
### DT-01-billing-payments-account-operations-P04-T002: Implement feature-slice coverage and tracker linkage for P04 - Phase 4 Cross Area
...
| Dependencies | DT-01-billing-payments-account-operations-P04-T001 |
...
- Source features covered in this phase: collections-and-adjustment, prepay-balance.
...
### DT-01-billing-payments-account-operations-P04-T003: Prove phase readiness with end-to-end, contract, accessibility, event replay, and reconciliation evidence
...
| Dependencies | DT-01-billing-payments-account-operations-P04-T002 |
