# Billing, Payments, And Account Operations Implementation File Usage

Reviewed: 2026-06-14

## Purpose

Use this guide when building `Billing, Payments, And Account Operations`. It explains which generated files matter, when to read them, and how they drive Angular, Spring Boot, PostgreSQL, TMF API, event, and privacy work.

## App Identity

| Item | Value |
| --- | --- |
| Suite | 02 BSS Commercial |
...
| App overview | [../billing-payments-account-operations.md](../billing-payments-account-operations.md) | Concise product scope, app purpose, TMF API usage, ownership, integrations, and first-release direction. |
...
| App TMF review | [../../tmf-api-ddl-reviews/billing-payments.md](../../tmf-api-ddl-reviews/billing-payments.md) | TMF APIs, resource-to-table mapping, field handling, event baseline, privacy/retention/audit baseline. |
| Suite V001 migration | [../../../../database/postgres/suites/ts_bss_commercial/V001__create_app_schemas_and_starter_tables.sql](../../../../database/postgres/suites/ts_bss_commercial/V001__create_app_schemas_and_starter_tables.sql) | Creates suite schemas, starter app tables, base controls, and outbox tables. |
| App V002+ migration | [../../../../database/postgres/suites/ts_bss_commercial/V005__refine_billing_payments_tmf_core.sql](../../../../database/postgres/suites/ts_bss_commercial/V005__refine_billing_payments_tmf_core.sql) | Promotes common TMF columns and creates app support tables, event_contract, and privacy_retention_policy. |
...
9. Use `billing_payments.event_contract` as the baseline event register and `billing_payments.event_outbox` for publication.
10. Use `billing_payments.privacy_retention_policy` as the baseline for masking, audit, retention, legal hold, and residency handling.
...
- Write only inside schema `billing_payments` for this app's operational data.
